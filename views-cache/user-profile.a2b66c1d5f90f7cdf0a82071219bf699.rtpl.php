        ...
        <div class="entity-profile-card">
            <div class="entity-profile-card-top card-category">
                <div class="entity-img">
                    <img src="<?php echo htmlspecialchars( $usuario["user_profilepicture"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="" srcset="">
                </div>
                ...
                <div class="entity-info sub-card-category">
                    ...
                    <div class="info-items">
                        ...
                        <div class="info-box">
                            ...
                            <h3 class="info-value"><?php if( $usuario["user_isadmin"] == 0 ){ ?>Não<?php }else{ ?>Sim<?php } ?></h3>
                        </div>
                        <div class="info-box">
                        ...
                        <div class="info-box">
                            ...
                            <h3 class="info-value phone-mask"><?php echo htmlspecialchars( $usuario["user_phone"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
                        </div>
                        <div class="info-box">

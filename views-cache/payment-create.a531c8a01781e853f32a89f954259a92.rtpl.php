            ...
            <div class="content-box">
                <form action="" method="post" class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="text-input" id="partner_fullname" name="partner_fullname" style="pointer-events: none;" value="<?php echo htmlspecialchars( $socio, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </div>
                    <div class="input-group">
                        <label for="payment_payer" class="label-input">Pagador <span class="mandatory">*</span></label>

    ...
    <div class="register-box">
        ...
        <div class="content-box">
            <form method="post" action="/admin/user/create" class="form-group" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    <label for="user_phone" class="label-input">Telefone <span class="mandatory">*</span></label>
                    <input type="text" class="text-input telefone" id="user_phone" name="user_phone">
                </div>
                <div class="input-group">
                ...
                <div class="input-check-group" style="height: 120px; margin-bottom: 0px;">
                    <span class="title-check">Administrador</span>
                    <div class="row check-row">
                        <div class="col-4-sm">
                            <label class="check-container">SIM
                        ...
                        <div class="col-4-sm">
                            <label class="check-container">NÃO
                                <input class="checkbox-single" type="checkbox" name="no" onclick="toggleAdmin(this)">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class='input-wrapper'>
                    ...
                    <input id='input-file' type='file' value='' name="user_profilepicture" onchange="photoPreview(event)" />
                </div>
